...
public interface StudentCardDao extends BaseDao<StudentCard, String> {
	public static final String HQL_LIST = "from StudentCard s where s.state > 0 ";
	public static final String HQL_LIST_DELETE = "from StudentCard s where s.state = 0 ";
	public static final String HQL_LIST_COUNT = "select count(s) from StudentCard s where s.state > 0";
